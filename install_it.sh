...
bazel-bin/tensorflow_estimator/tools/pip_package/build_pip_package "$TF_PKG_DIR"
TF_PKG_NAME="$(ls $TF_PKG_DIR | grep .whl)"
"$PIP_COMMAND" uninstall -y tf-estimator tf-estimator-nightly tensorflow_estimator
